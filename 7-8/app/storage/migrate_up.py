...
async def migrate_up(connection_str: str, path: str, file_name) -> None:
    """
    ...
    try:
        with open(pl.Path(path + file_name), 'r', encoding='utf-8') as response:
            ...
            print("LOG: migration up: Pass")
    except:
        print("LOG: migration up: Error")


if __name__ == "__main__":
    aio.run(migrate_up(*CONFIG, '../responses/migrate-up.sql'))